import css from "@/app/(marketing)/_components/PopularCategoryCard/PopularCategoryCard.module.scss"
...
export default function PopularCategoryCard({name, description, icon, link, textLink}: ICategoriesCardProps) {
   return (
